...
public class Listeners implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        htmlReporter.config().setDocumentTitle("Future Home Test"); // Tile of report
        htmlReporter.config().setReportName("Selenium OrangeHRM"); // name of the report
        htmlReporter.config().setTheme(Theme.STANDARD);

        extent = new ExtentReports();
        extent.attachReporter(htmlReporter);
        extent.setSystemInfo("Project Name", "Future Home Selenium");
